# GCS Bucket - Object Versioning Example

Creates a Google Cloud Storage bucket with object versioning enabled. Versioning keeps a history of all object versions, protecting against accidental deletes and overwrites.
